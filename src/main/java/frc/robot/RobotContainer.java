...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    m_drivetrainSubsystem.setDefaultCommand(new DefaultDriveCommand(
            ...
            () -> -modifyAxis(m_controller.getLeftY()) * 0.5,//DrivetrainSubsystem.MAX_VELOCITY_METERS_PER_SECOND,
            () -> -modifyAxis(m_controller.getLeftX()) * 0.5,//DrivetrainSubsystem.MAX_VELOCITY_METERS_PER_SECOND,
