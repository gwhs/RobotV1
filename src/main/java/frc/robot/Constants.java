...
public final class Constants {
     ...
     */
    public static final double DRIVETRAIN_TRACKWIDTH_METERS = 0.470; // 18.5" // FIXME Measure and set trackwidth
    /**
     * The front-to-back distance between the drivetrain wheels.
     *
     * Should be measured from center to center.
     */
    public static final double DRIVETRAIN_WHEELBASE_METERS = 0.473; //18.625" // FIXME Measure and set wheelbase

    //public static final int DRIVETRAIN_PIGEON_ID = 30; // FIXME Set Pigeon ID
