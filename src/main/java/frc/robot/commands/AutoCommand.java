...
public class AutoCommand extends SequentialCommandGroup {
    ...
    public AutoCommand(DrivetrainSubsystem m_drivetrainSubsystem) {
        ...
        addCommands(new InstantCommand(() -> m_drivetrainSubsystem.resetOdometry(interesting.getInitialPose())),
                    new PPSwerveControllerCommand(
                        ...
                        // new WaitCommand(2),
                        // //new InstantCommand(() -> m_drivetrainSubsystem.resetOdometry(test2.getInitialPose())),
                        // new PPSwerveControllerCommand(
                        //     test2,
                        //     m_drivetrainSubsystem::getPose,
                        //     m_drivetrainSubsystem.getKinematics(),
